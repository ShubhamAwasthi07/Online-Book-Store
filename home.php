...
<header class="header">
    ...
    <div class="header-1">
        ...
        <a href="#" class="logo"> <i class="fas fa-book"></i> TheBookSpot </a>
        ...
        <div class="icons">
            ...
            <a href="#" class="fas fa-heart" title="favourite"></a>
            <a href="#" class="fas fa-shopping-cart" title="Shopping cart"></a>
            <div id="login-btn" class="fas fa-user" title="User"></div>
            <a style="font-size:24px"><i class="fa fa-sign-out" title="Logout"></i></a>
        </div>
...
<div class="login-form-container">
    ...
    <form action="" method= "post">
        ...
        <p>don't have an account ? <a href="index.php">create new</a></p>
...
<section class="footer">
    ...
    <div class="box-container">
        ...
        <div class="box">
            ...
            <a href="#"> <i class="fas fa-envelope"></i> Shubham07070@gmail.com </a>
    ...
    <div class="credit"> created by <span>Mr.Shubham Awasthi</span> | all rights reserved! </div>
